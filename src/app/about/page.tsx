  ...
  return (
    <div className="flex flex-col gap-6">
      ...
      <div className="flex max-w-prose flex-col gap-3 text-sm leading-relaxed text-ink">
        <p>
          Add/Drop is a refresh-and-hope game on eOffice. The cohort is already
          trading electives over WhatsApp DMs. There&rsquo;s just no central
          place to see who wants what.
        </p>
        <p>
          This site is that central place. Nothing more. Post what you want to
          drop, post what you want to add, and DM the people you match with. No
          matching algorithm, no notifications, no chat. Just signal.
        </p>
        <p>
          Built by{' '}
          <a
